...
イラストモジュールは全5点構成です。前3点は絵文字、後ろ2点は **A4横向き（297 × 210 mm）の等比** 横長フレームです。
以下のファイルを `assets/img/` に置けば差し替わります：

| ファイル | 表示位置 |
| --- | --- |
| `illust-a4-1.jpg` | 4作目（横長1枚） |
| `illust-a4-2.jpg` | 5作目・**表**（ホバー前） |
| `illust-a4-3.jpg` | 5作目・**裏**（ホバーで表示） |

5作目はマウスホバー（またはフォーカス）で裏返り、表・裏で2枚のイラストを見せられます。
